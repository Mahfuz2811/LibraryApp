...
<head>
    ...
    <script type="text/javascript" src="{{ url('admin/js/pages/datatables_sorting.js') }}"></script>

    <script type="text/javascript" src="{{ url('admin/js/plugins/ui/ripple.min.js') }}"></script>


    <script type="text/javascript" src="{{ url('admin/js/plugins/forms/wizards/form_wizard/form.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('admin/js/plugins/forms/wizards/form_wizard/form_wizard.min.js') }}"></script>




    <script type="text/javascript" src="{{ url('admin/js/core/libraries/jquery_ui/interactions.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ url('admin/js/pages/wizard_form.js') }}"></script>
