...
@section('content')
    ...
    {!! Form::open(['url' => route('admin_form_post'), 'method' => 'post', 'class' => 'form-horizontal form-validate-jquery', 'files' => 'true', 'enctype' => "multipart/form-data"]) !!}

    <!-- Content panel -->
    <div class="panel panel-default border-grey">
        <div class="panel-heading">
            <h6 class="panel-title">Create Form Download</h6>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-2 text-right">Attachment <span class="text-danger">*</span></label>
                            <div class="col-lg-10">
