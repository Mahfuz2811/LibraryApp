...
@section('content')
    ...
    {!! Form::open(['url' => route('admin_book_edit_post', ['id' => $book->id]), 'method' => 'post', 'class' => 'form-horizontal form-validate-jquery', 'files' => 'true', 'enctype' => "multipart/form-data"]) !!}
                ...
                <div class="col-md-12">
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="book_name" value="{{ $book->book_name }}" class="form-control" required="required" placeholder="Enter Book Name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="author_name" value="{{ $book->author_name }}" class="form-control" required="required" placeholder="Enter Author Name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <textarea class="md-input" id="ckeditor" name="details" required>{{ $book->details }}</textarea>
                            </div>
                        </div>
