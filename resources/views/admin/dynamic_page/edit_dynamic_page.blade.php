...
@section('content')
    ...
    {!! Form::open(['url' => route('admin_dynamic_page_edit_post', ['id' => $page->id]), 'method' => 'post', 'class' => 'form-horizontal form-validate-jquery', 'files' => 'true', 'enctype' => "multipart/form-data"]) !!}
                ...
                <div class="col-md-12">
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="title" value="{{ $page->title }}" class="form-control" required="required" placeholder="Enter title">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <textarea class="md-input" id="ckeditor" name="details" required>{{ $page->details }}</textarea>
                            </div>
                        </div>
