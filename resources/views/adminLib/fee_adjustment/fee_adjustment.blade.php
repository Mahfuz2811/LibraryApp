    ...
    {!! Form::open(['url' => route('admin_lib_book_store'), 'method' => 'post', 'class' => 'form-horizontal']) !!}
        ...
        <div class="panel panel-default border-grey">
            <div class="panel-heading">
                <h6 class="panel-title">Set Fee Adjustment</h6>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <fieldset class="content-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3 text-right">Fee Amount <span class="text-danger">*</span></label>
                                <div class="col-lg-7">
                                    <input type="text" name="student_name" value="{{ old('student_name') }}" class="form-control" placeholder="Enter Fee Amount">
