			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h6 class="form-wizard-title text-semibold">
						...
						Student Information
						<small class="display-block">Student details</small>
					</h6>
				</div>
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<select class="select-search">
							<optgroup label="Mountain Time Zone">
								<option value="AZ">আম</option>
								<option value="CO">জাম</option>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3">Previous book : </label>
                        <div class="col-lg-7">
                            <label>3</label>
                        </div>
                    </div>
		...
		<div class="col-md-6">
			<div class="panel panel-flat">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3"> copy: </label>
                        <div class="col-lg-7">
                            <label>3</label>
                        </div>s
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3"> issued book: </label>
                        <div class="col-lg-7">
                            <label>2</label>
                        </div>
                    </div>
